...
export default class BaseController<S,T> {
    baseManager: BaseManager<S,T>;

    constructor(baseManager: BaseManager<S,T>) {
    ...
    public async getById(req: Request, res: Response) {
        try {
            ...
            if (!data) { throw new Error("API Error: error retrieving resource") }
            return res.status(200).send({
    ...
    public async create(req: Request, res: Response) {
        try {
            ...
            if (!created) { throw new Error("API Error: error creating resource") }
            return res.status(200).send({
    ...
    public async delete(req: Request, res: Response) {
        try {
            ...
            if (!deleted) { throw new Error("API Error: error removing resource") }
            return res.status(200).send({
    ...
    public async update(req: Request, res: Response) {
        try {
            ...
            if (!updated) { throw new Error("API Error: error updating resource") }
            return res.status(200).send({
    ...
    public async set(req: Request, res: Response) {
        try {
            ...
            if (!updated) { throw new Error("API Error: error setting resource") }
            return res.status(200).send({
                message: `Resource updated successfully`,
                data: updated
            });
